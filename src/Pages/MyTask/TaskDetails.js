...
const TaskDetails = () => {
    ...
    return (
        ...
        <div className='flex justify-center items-center my-16'>
            <div className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row w-9/12 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
