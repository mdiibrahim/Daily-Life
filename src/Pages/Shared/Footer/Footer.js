        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-80">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to='/' className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Daily Life</span>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to='/' className="hover:underline">Daily Life™</Link>. All Rights Reserved.
                    </span>
