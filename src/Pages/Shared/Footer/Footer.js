...
const Footer = () => {
    return (
        <div>
            ...
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-80">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <Link to='/' class="flex items-center">
                            <img src={logo} class="mr-3 w-16" alt="FlowBite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Daily Life</span>
                        </Link>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to='/' class="hover:underline">Daily Life™</Link>. All Rights Reserved.
                    </span>
